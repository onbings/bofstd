...
template <class TClass> class DelegateMemberSpAsync0 : public DelegateMemberSp0<TClass>, public IDelegateInvoker
{
public:
  ...
  DelegateMemberSpAsync0(ObjectPtr object, MemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  DelegateMemberSpAsync0(ObjectPtr object, ConstMemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  ...
  virtual bool operator==(const DelegateBase &rhs) const
  {
    ...
    return derivedRhs && m_thread == derivedRhs->m_thread && DelegateMemberSp0<TClass>::operator==(rhs);
  }
...
template <class TClass, class Param1> class DelegateMemberSpAsync1 : public DelegateMemberSp1<TClass, Param1>, public IDelegateInvoker
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  DelegateMemberSpAsync1(ObjectPtr object, MemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  DelegateMemberSpAsync1(ObjectPtr object, ConstMemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  ...
  virtual bool operator==(const DelegateBase &rhs) const
  {
    ...
    return derivedRhs && m_thread == derivedRhs->m_thread && DelegateMemberSp1<TClass, Param1>::operator==(rhs);
  }
...
template <class TClass, class Param1, class Param2> class DelegateMemberSpAsync2 : public DelegateMemberSp2<TClass, Param1, Param2>, public IDelegateInvoker
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  // Contructors take a class instance, member function, and callback thread
  DelegateMemberSpAsync2(ObjectPtr object, MemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  DelegateMemberSpAsync2(ObjectPtr object, ConstMemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  ...
  virtual bool operator==(const DelegateBase &rhs) const
  {
    ...
    return derivedRhs && m_thread == derivedRhs->m_thread && DelegateMemberSp2<TClass, Param1, Param2>::operator==(rhs);
  }
...
template <class TClass, class Param1, class Param2, class Param3> class DelegateMemberSpAsync3 : public DelegateMemberSp3<TClass, Param1, Param2, Param3>, public IDelegateInvoker
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  // Contructors take a class instance, member function, and callback thread
  DelegateMemberSpAsync3(ObjectPtr object, MemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  DelegateMemberSpAsync3(ObjectPtr object, ConstMemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  ...
  virtual bool operator==(const DelegateBase &rhs) const
  {
    ...
    return derivedRhs && m_thread == derivedRhs->m_thread && DelegateMemberSp3<TClass, Param1, Param2, Param3>::operator==(rhs);
  }
...
template <class TClass, class Param1, class Param2, class Param3, class Param4> class DelegateMemberSpAsync4 : public DelegateMemberSp4<TClass, Param1, Param2, Param3, Param4>, public IDelegateInvoker
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  // Contructors take a class instance, member function, and callback thread
  DelegateMemberSpAsync4(ObjectPtr object, MemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  DelegateMemberSpAsync4(ObjectPtr object, ConstMemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  ...
  virtual bool operator==(const DelegateBase &rhs) const
  {
    ...
    return derivedRhs && m_thread == derivedRhs->m_thread && DelegateMemberSp4<TClass, Param1, Param2, Param3, Param4>::operator==(rhs);
  }
...
template <class TClass, class Param1, class Param2, class Param3, class Param4, class Param5> class DelegateMemberSpAsync5 : public DelegateMemberSp5<TClass, Param1, Param2, Param3, Param4, Param5>, public IDelegateInvoker
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  // Contructors take a class instance, member function, and callback thread
  DelegateMemberSpAsync5(ObjectPtr object, MemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  DelegateMemberSpAsync5(ObjectPtr object, ConstMemberFunc func, DelegateThread *thread)
  {
    Bind(object, func, thread);
  }
  ...
  virtual bool operator==(const DelegateBase &rhs) const
  {
    ...
    return derivedRhs && m_thread == derivedRhs->m_thread && DelegateMemberSp5<TClass, Param1, Param2, Param3, Param4, Param5>::operator==(rhs);
  }
...
// N=0
template <class TClass> DelegateMemberSpAsync0<TClass> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(), DelegateThread *thread)
{
  return DelegateMemberSpAsync0<TClass>(object, func, thread);
}

template <class TClass> DelegateMemberSpAsync0<TClass> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)() const, DelegateThread *thread)
{
  return DelegateMemberSpAsync0<TClass>(object, func, thread);
}

// N=1
template <class TClass, class Param1> DelegateMemberSpAsync1<TClass, Param1> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(Param1 p1), DelegateThread *thread)
{
  return DelegateMemberSpAsync1<TClass, Param1>(object, func, thread);
}

template <class TClass, class Param1> DelegateMemberSpAsync1<TClass, Param1> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(Param1 p1) const, DelegateThread *thread)
{
  return DelegateMemberSpAsync1<TClass, Param1>(object, func, thread);
}

// N=2
template <class TClass, class Param1, class Param2> DelegateMemberSpAsync2<TClass, Param1, Param2> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(Param1 p1, Param2 p2), DelegateThread *thread)
{
  return DelegateMemberSpAsync2<TClass, Param1, Param2>(object, func, thread);
}

template <class TClass, class Param1, class Param2> DelegateMemberSpAsync2<TClass, Param1, Param2> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(Param1 p1, Param2 p2) const, DelegateThread *thread)
{
  return DelegateMemberSpAsync2<TClass, Param1, Param2>(object, func, thread);
}

// N=3
template <class TClass, class Param1, class Param2, class Param3> DelegateMemberSpAsync3<TClass, Param1, Param2, Param3> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(Param1 p1, Param2 p2, Param3 p3), DelegateThread *thread)
{
  return DelegateMemberSpAsync3<TClass, Param1, Param2, Param3>(object, func, thread);
}

template <class TClass, class Param1, class Param2, class Param3> DelegateMemberSpAsync3<TClass, Param1, Param2, Param3> MakeDelegate(std::shared_ptr<TClass> object, void (TClass::*func)(Param1 p1, Param2 p2, Param3 p3) const, DelegateThread *thread)
{
  return DelegateMemberSpAsync3<TClass, Param1, Param2, Param3>(object, func, thread);
}
