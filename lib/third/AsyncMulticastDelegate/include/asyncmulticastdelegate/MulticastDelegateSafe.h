...
template <typename Param1> class MulticastDelegateSafe1 : public MulticastDelegate1<Param1>
{
public:
...
template <typename Param1, typename Param2> class MulticastDelegateSafe2 : public MulticastDelegate2<Param1, Param2>
{
public:
  MulticastDelegateSafe2()
  {
    LockGuard::Create(&m_lock);
  }
  ~MulticastDelegateSafe2()
...
template <typename Param1, typename Param2, typename Param3> class MulticastDelegateSafe3 : public MulticastDelegate3<Param1, Param2, Param3>
{
public:
  MulticastDelegateSafe3()
  {
    LockGuard::Create(&m_lock);
  }
  ~MulticastDelegateSafe3()
...
template <typename Param1, typename Param2, typename Param3, typename Param4> class MulticastDelegateSafe4 : public MulticastDelegate4<Param1, Param2, Param3, Param4>
{
public:
  MulticastDelegateSafe4()
  {
    LockGuard::Create(&m_lock);
  }
  ~MulticastDelegateSafe4()
...
template <typename Param1, typename Param2, typename Param3, typename Param4, typename Param5> class MulticastDelegateSafe5 : public MulticastDelegate5<Param1, Param2, Param3, Param4, Param5>
{
public:
  MulticastDelegateSafe5()
  {
    LockGuard::Create(&m_lock);
  }
  ~MulticastDelegateSafe5()
