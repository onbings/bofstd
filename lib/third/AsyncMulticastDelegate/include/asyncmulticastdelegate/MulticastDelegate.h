...
public:
  ...
  void operator()()
  {
    ...
    while (node != 0)
    {
      Delegate0<> *delegate = static_cast<Delegate0<> *>(node->Delegate);
...
template <typename Param1> class MulticastDelegate1 : public MulticastDelegateBase
{
public:
  MulticastDelegate1()
  {
...
template <typename Param1, class Param2> class MulticastDelegate2 : public MulticastDelegateBase
{
public:
  MulticastDelegate2()
  {
  ...
  void operator()(Param1 p1, Param2 p2)
  {
    ...
    while (node != 0)
    {
      Delegate2<Param1, Param2> *delegate = static_cast<Delegate2<Param1, Param2> *>(node->Delegate);
...
template <typename Param1, class Param2, class Param3> class MulticastDelegate3 : public MulticastDelegateBase
{
public:
  MulticastDelegate3()
  {
  ...
  void operator()(Param1 p1, Param2 p2, Param3 p3)
  {
    ...
    while (node != 0)
    {
      Delegate3<Param1, Param2, Param3> *delegate = static_cast<Delegate3<Param1, Param2, Param3> *>(node->Delegate);
...
template <typename Param1, class Param2, class Param3, class Param4> class MulticastDelegate4 : public MulticastDelegateBase
{
public:
  MulticastDelegate4()
  {
  ...
  void operator()(Param1 p1, Param2 p2, Param3 p3, Param4 p4)
  {
    ...
    while (node != 0)
    {
      Delegate4<Param1, Param2, Param3, Param4> *delegate = static_cast<Delegate4<Param1, Param2, Param3, Param4> *>(node->Delegate);
...
template <typename Param1, class Param2, class Param3, class Param4, class Param5> class MulticastDelegate5 : public MulticastDelegateBase
{
public:
  MulticastDelegate5()
  {
  ...
  void operator()(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)
  {
    ...
    while (node != 0)
    {
      Delegate5<Param1, Param2, Param3, Param4, Param5> *delegate = static_cast<Delegate5<Param1, Param2, Param3, Param4, Param5> *>(node->Delegate);
