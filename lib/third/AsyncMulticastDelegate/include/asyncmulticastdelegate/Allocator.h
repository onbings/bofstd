...
template <class T, uint32_t Objects> class AllocatorPool : public Allocator
{
public:
...
#define IMPLEMENT_ALLOCATOR(class, objects, memory) Allocator class ::_allocator(sizeof(class), objects, memory, #class);
