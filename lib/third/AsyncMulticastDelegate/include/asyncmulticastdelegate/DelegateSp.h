...
template <class TClass, class RetType = void> class DelegateMemberSp0 : public Delegate0<RetType>
{
public:
  ...
  DelegateMemberSp0(ObjectPtr object, MemberFunc func)
  {
    Bind(object, func);
  }
  DelegateMemberSp0(ObjectPtr object, ConstMemberFunc func)
  {
    Bind(object, func);
  }
...
template <class TClass, class Param1, class RetType = void> class DelegateMemberSp1 : public Delegate1<Param1, RetType>
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  DelegateMemberSp1(ObjectPtr object, MemberFunc func)
  {
    Bind(object, func);
  }
  DelegateMemberSp1(ObjectPtr object, ConstMemberFunc func)
  {
    Bind(object, func);
  }
...
template <class TClass, class Param1, class Param2, class RetType = void> class DelegateMemberSp2 : public Delegate2<Param1, Param2, RetType>
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  DelegateMemberSp2(ObjectPtr object, MemberFunc func)
  {
    Bind(object, func);
  }
  DelegateMemberSp2(ObjectPtr object, ConstMemberFunc func)
  {
    Bind(object, func);
  }
...
template <class TClass, class Param1, class Param2, class Param3, class RetType = void> class DelegateMemberSp3 : public Delegate3<Param1, Param2, Param3, RetType>
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  DelegateMemberSp3(ObjectPtr object, MemberFunc func)
  {
    Bind(object, func);
  }
  DelegateMemberSp3(ObjectPtr object, ConstMemberFunc func)
  {
    Bind(object, func);
  }
...
template <class TClass, class Param1, class Param2, class Param3, class Param4, class RetType = void> class DelegateMemberSp4 : public Delegate4<Param1, Param2, Param3, Param4, RetType>
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  DelegateMemberSp4(ObjectPtr object, MemberFunc func)
  {
    Bind(object, func);
  }
  DelegateMemberSp4(ObjectPtr object, ConstMemberFunc func)
  {
    Bind(object, func);
  }
...
template <class TClass, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType = void> class DelegateMemberSp5 : public Delegate5<Param1, Param2, Param3, Param4, Param5, RetType>
{
public:
  typedef std::shared_ptr<TClass> ObjectPtr;
  ...
  DelegateMemberSp5(ObjectPtr object, MemberFunc func)
  {
    Bind(object, func);
  }
  DelegateMemberSp5(ObjectPtr object, ConstMemberFunc func)
  {
    Bind(object, func);
  }
...
// N=0
template <class TClass, class RetType> DelegateMemberSp0<TClass, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)())
{
  return DelegateMemberSp0<TClass, RetType>(object, func);
}

template <class TClass, class RetType> DelegateMemberSp0<TClass, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)() const)
{
  return DelegateMemberSp0<TClass, RetType>(object, func);
}

// N=1
template <class TClass, class Param1, class RetType> DelegateMemberSp1<TClass, Param1, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)(Param1 p1))
{
  return DelegateMemberSp1<TClass, Param1, RetType>(object, func);
}

template <class TClass, class Param1, class RetType> DelegateMemberSp1<TClass, Param1, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)(Param1 p1) const)
{
  return DelegateMemberSp1<TClass, Param1, RetType>(object, func);
}

// N=2
template <class TClass, class Param1, class Param2, class RetType> DelegateMemberSp2<TClass, Param1, Param2, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)(Param1 p1, Param2 p2))
{
  return DelegateMemberSp2<TClass, Param1, Param2, RetType>(object, func);
}

template <class TClass, class Param1, class Param2, class RetType> DelegateMemberSp2<TClass, Param1, Param2, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)(Param1 p1, Param2 p2) const)
{
  return DelegateMemberSp2<TClass, Param1, Param2, RetType>(object, func);
}

// N=3
template <class TClass, class Param1, class Param2, class Param3, class RetType> DelegateMemberSp3<TClass, Param1, Param2, Param3, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)(Param1 p1, Param2 p2, Param3 p3))
{
  return DelegateMemberSp3<TClass, Param1, Param2, Param3, RetType>(object, func);
}

template <class TClass, class Param1, class Param2, class Param3, class RetType> DelegateMemberSp3<TClass, Param1, Param2, Param3, RetType> MakeDelegate(std::shared_ptr<TClass> object, RetType (TClass::*func)(Param1 p1, Param2 p2, Param3 p3) const)
{
  return DelegateMemberSp3<TClass, Param1, Param2, Param3, RetType>(object, func);
}
