...
template <class RetType = void> class SinglecastDelegate0
{
public:
...
template <typename Param1, class RetType = void> class SinglecastDelegate1
{
public:
...
template <typename Param1, class Param2, class RetType = void> class SinglecastDelegate2
{
public:
...
template <typename Param1, class Param2, class Param3, class RetType = void> class SinglecastDelegate3
{
public:
...
template <typename Param1, class Param2, class Param3, class Param4, class RetType = void> class SinglecastDelegate4
{
public:
...
template <typename Param1, class Param2, class Param3, class Param4, class Param5, class RetType = void> class SinglecastDelegate5
{
public:
  ...
  {
    return (*m_delegate)(p1, p2, p3, p4, p5);
  } // Invoke delegate callback
