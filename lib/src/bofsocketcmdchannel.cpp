...
BofSocketCmdChannel::BofSocketCmdChannel(const std::shared_ptr<BofSocketChannelManager> &_rpsBofSocketChannelManager, const BOF_SOCKET_CMD_CHANNEL_PARAM &_rBofCmdSocketChannelParam_X)
{
  ...
  if (mpsMtx_X)
  {
    mErrorCode_E = BOF_NAMESPACE::Bof_CreateMutex("BofSocketCmdChannel", false, false, *mpsMtx_X);
...
std::shared_ptr<BofSocketCmdChannel> BofSocketCmdChannel::S_BofSocketCmdChannelFactory(const std::shared_ptr<BofSocketChannelManager> &_rpsBofSocketChannelManager, const BOF_SOCKET_CMD_CHANNEL_PARAM &_rBofSocketChannelParam_X)
{
...
BOFERR BofSocketCmdChannel::OnReadCallback(uint32_t /*_Id_U32*/, std::shared_ptr<BOF_NAMESPACE::BofSocketChannel> /*_psBofSocketChannel*/, const BOF_BUFFER & /*_rBuffer_X*/, const BOF_SOCKET_PEER_INFO & /*_rPeerInfo_X*/)
{
  BOFERR Rts_E = BOFERR_NO_ERROR;
  return Rts_E;
}
